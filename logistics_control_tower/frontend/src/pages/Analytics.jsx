...
const Analytics = () => {
  ...
  const hasChartData = distData.length > 0;
    ...
    <div className="min-h-screen bg-slate-50 p-6 font-sans">
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-24 text-slate-400">
          ...
          <p className="text-lg font-semibold text-slate-600">Loading analytics…</p>
          <p className="text-sm mt-1">Fetching optimization history from the server.</p>
        </div>
      )}
      ...
      {!loading && !hasChartData && (
        <div className="flex flex-col items-center justify-center py-20 text-slate-400">
          ...
          <p className="text-lg font-semibold text-slate-600">No optimization runs yet</p>
          <p className="text-sm mt-1">
            Run an optimization from the <strong>Route Planner</strong> to populate charts here.
          </p>
        </div>
      )}
